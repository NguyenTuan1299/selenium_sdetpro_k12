...
public class DynamicControl {
    ...
    private static final By CHCKBX_INPUT_ELE_SEL = By.cssSelector("#checkbox-example input");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement checkboxInputEle = checkboxFormEle.findElement(CHCKBX_INPUT_ELE_SEL);
            ...
            removeBtnEle.click();
            wait.until(ExpectedConditions.invisibilityOfElementLocated(CHCKBX_INPUT_ELE_SEL));
